...
|-----|------|----------|-------------------------|----------|-----------|
| 1 | Edge Computing | Bộ xử lý trung tâm | NVIDIA Jetson Nano 4GB RAM | 1 | Xử lý AI, điều phối hệ thống |
| 2 | IoT Device | Camera | IMX219 8MP CSI | 1 | Thu thập hình ảnh lá lúa |
| 3 | IoT Device | Vi điều khiển | Arduino Uno R3 | 1 | Đọc dữ liệu cảm biến |
| 4 | IoT Device | Cảm biến nhiệt độ/độ ẩm | DHT22 | 1 | Đo nhiệt độ và độ ẩm không khí |
| 5 | IoT Device | Cảm biến độ ẩm đất | Capacitive Soil Moisture | 1 | Đo độ ẩm đất |
| 6 | IoT Device | Cảm biến ánh sáng | VEML7700 (I²C) | 1 | Đo cường độ ánh sáng |
| 7 | IoT Device | Cảm biến gió | Hall Effect Anemometer | 1 | Đo tốc độ gió |
| 8 | IoT Device | Cảm biến pH | Analog pH Sensor | 1 | Đo độ pH đất/nước |
| 9 | IoT Device | Cảm biến mức nước | Float Switch XKC-Y25 | 2 | Giám sát mức thuốc |
| 10 | IoT Device | Module GPS | GPS NEO-7M | 1 | Định vị vị trí |
| 11 | IoT Device | Module điều khiển | ESP32 NodeMCU | 1 | Điều khiển bơm phun |
| 12 | IoT Device | Driver động cơ | L298N H-Bridge | 1 | Điều khiển động cơ bơm |
| 13 | IoT Device | Bơm nước | RS385 12VDC | 2 | Phun thuốc trừ sâu |
